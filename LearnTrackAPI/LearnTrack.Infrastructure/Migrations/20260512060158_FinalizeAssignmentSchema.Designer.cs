...
namespace LearnTrack.Infrastructure.Migrations
{
    ...
    [Migration("20260512060158_FinalizeAssignmentSchema")]
    partial class FinalizeAssignmentSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnTrack.Core.Entities.Course", b =>
                {
                    b.HasOne("LearnTrack.Core.Entities.CourseCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CourseCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LearnTrack.Core.Entities.CourseProvider", "Provider")
                        .WithMany()
